 ...
 */
final class Scp04Model extends BaseModel
{
    const REQUEST_URL = 'https://gateway.hnapay.com/scp/scp04.do';

    /** @var string 版本 */
    const VERSION = '2.0';

    /** @var string 交易代码 */
    const TRANCODE = 'SCP04';
    ...
    public function __construct()
    {
        ...
        $this->scp04InfoModel = new Scp04InfoModel();
    }
    ...
    public function copy($data)
    {
        ...
        $this->scp04InfoModel->copy($data);

        $this->msgCiphertext = $this->scp04InfoModel->getMsgCipherText($this->publicKey);
