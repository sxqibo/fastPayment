 ...
 */
final class Scp03Model extends BaseModel
{
    const REQUEST_URL = 'https://gateway.hnapay.com/scp/scp03.do';

    /** @var string 版本 */
    const VERSION = '2.0';

    /** @var string 交易代码 */
    const TRANCODE = 'SCP03';
    ...
    const VERIFY_FIELD = [
        ...
        'signType', 'resultCode', 'errorCode', 'terminalId',
    ];
    ...
    public function __construct()
    {
        ...
        $this->scp03InfoModel = new Scp03InfoModel();
    }
    ...
    public function copy($data)
    {
        ...
        $this->scp03InfoModel->copy($data);

        $this->msgCiphertext = $this->scp03InfoModel->getMsgCipherText($this->publicKey);
