 ...
 */
final class PayModel extends BaseModel
{
    const REQUEST_URL= 'https://gateway.hnapay.com/scp/pay.do';

    /** @var string 版本 */
    const VERSION = '2.0';

    /** @var string 交易代码 */
    const TRANCODE = 'SCP01';
    ...
    /** @var string[] 签名字段 */
    const SIGN_FIELD =  [
        'version', 'tranCode', 'merId', 'merOrderId', 'submitTime',
        'msgCiphertext','signType'
    ];
    ...
    public function copy($data)
    {
        ...
        $this->payInfoModel->copy($data);

        $this->msgCiphertext = $this->payInfoModel->getMsgCipherText($this->publicKey);
